...
if ($fragment) {
    ...
    <div class="player-profile-modal p-3">
        ...
        <div class="player-meta small">
            <div><strong>Team:</strong> <?= htmlspecialchars($player['team_name'] ?? 'Not assigned') ?></div>
            ...
            <div class="page-header-content d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="text-end">
                        ...
                        <?php if (!empty($player['nickname'])): ?><div class="text-muted">"<?= htmlspecialchars($player['nickname']) ?>"</div><?php endif; ?>
                        <div class="small"><strong>Team:</strong> <?= htmlspecialchars($player['team_name'] ?? 'Not assigned') ?> &nbsp; <strong>#</strong><?= htmlspecialchars($player['jersey_number'] ?? '—') ?></div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" disabled>
                                            ...
                                            <?php foreach ($teams as $t): ?>
                                                <option value="<?= $t['id'] ?>" <?= isset($player['team_id']) && $player['team_id'] == $t['id'] ? 'selected' : '' ?>><?= htmlspecialchars($t['name']) ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
