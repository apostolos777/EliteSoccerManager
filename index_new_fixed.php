...
// Include the header which contains sidebar navigation
include 'header.php';
...
// Load club settings including colors
$clubSettings = [
...
<style>
    :root {
        --club-primary: <?php echo $clubSettings['color_primary']; ?>;
        --club-secondary: <?php echo $clubSettings['color_secondary']; ?>;
        --club-accent: <?php echo $clubSettings['color_accent']; ?>;
        --club-success: <?php echo $clubSettings['color_success']; ?>;
        --club-warning: <?php echo $clubSettings['color_warning']; ?>;
        --club-danger: <?php echo $clubSettings['color_danger']; ?>;
    }
    ...
    <div class="container-fluid">
        ...
        <div class="welcome-banner">
            <div class="welcome-content">
                <h1 class="mb-2"><?php echo $greeting; ?>, <?php echo htmlspecialchars($user['first_name'] ?? 'Coach'); ?>!</h1>
        ...
        <div class="quick-actions">
            ...
            <a href="add_event.php" class="quick-action-card">
                <div class="quick-action-icon">
